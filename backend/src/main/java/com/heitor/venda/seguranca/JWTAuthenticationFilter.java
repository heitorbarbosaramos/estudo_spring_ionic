...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    @Override
    public Authentication attemptAuthentication(HttpServletRequest req, HttpServletResponse res) throws ArithmeticException{
    ...
    protected void successfulAuthentication(HttpServletRequest req, HttpServletResponse res, FilterChain chain, Authentication auth) throws IOException, ServletException{
        ...
        String username = ((SpringUserSecurity) auth.getPrincipal()).getUsername();
        String token = jwtUtil.gerandoToken(username);
